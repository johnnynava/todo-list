...
addTaskAddBtn.addEventListener("click", (e) => {
  ...
  _todo_logic_js__WEBPACK_IMPORTED_MODULE_0__.list.projects[selectedProjectIndex].createTask(
    ...
    btn.addEventListener("click", () => {
      ...
      _todo_logic_js__WEBPACK_IMPORTED_MODULE_0__.list.projects[selectedProjectIndex].tasks.forEach((task) => {
        if (task.id === btn.value) {
          selectedTask = task;
          selectedTaskIndex =
            _todo_logic_js__WEBPACK_IMPORTED_MODULE_0__.list.projects[selectedProjectIndex].tasks.indexOf(selectedTask);
...
editTaskAddBtn.addEventListener("click", (e) => {
  ...
  _todo_logic_js__WEBPACK_IMPORTED_MODULE_0__.list.projects[selectedProjectIndex].tasks[selectedTaskIndex].changeTitle(
    document.querySelector("#editTaskName").value
  );
  _todo_logic_js__WEBPACK_IMPORTED_MODULE_0__.list.projects[selectedProjectIndex].tasks[
    selectedTaskIndex
  ].changeDescription(document.querySelector("#editTaskDescription").value);
  _todo_logic_js__WEBPACK_IMPORTED_MODULE_0__.list.projects[selectedProjectIndex].tasks[selectedTaskIndex].changeDueDate(
    dueDate
  );
  _todo_logic_js__WEBPACK_IMPORTED_MODULE_0__.list.projects[selectedProjectIndex].tasks[selectedTaskIndex].changePriority(
    priority
  );
  localStorage.setItem("list", JSON.stringify(_todo_logic_js__WEBPACK_IMPORTED_MODULE_0__.list));
  cleanOldTasks();
